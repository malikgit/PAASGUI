...
//Controller1: VpcCtrl
app.controller('VpcCtrl', function($compile, $scope, $window, srvShareData, $location,$http) {
  ...
  /*End of shareMyData method*/
     ...
     $scope.deleteData = function(data) {
  	...
  	//Upload XML VPC File
  	$scope.uploadXmlVpcFile = function(){
        ...
        reader.onloadend = function(e){
      	  ...
      	  var res = $http.post('/paas-gui/rest/vpcService/addXmlVpc', $scope.data);
     ...
     };//End of uploadXmlVpcFile method  exportXmlVpc
     
     //Download VPC XML File
     $scope.exportXmlVpc = function() {
    	 var response = $http.get('/paas-gui/rest/vpcService/exportXmlVpcData');
    	 response.success(function(data){
    		 ...
    		 element.href = url;
    		 element.setAttribute('download', 'vpc.xml');
